    ...
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 sm:p-8 mx-auto">
      <div className="flex flex-col md:flex-row justify-between items-center mb-6 sm:mb-10 gap-4 sm:gap-6">
        <div className="text-center sm:text-left">
          <h2 className="text-2xl sm:text-3xl font-black text-gray-900 tracking-tight flex items-center justify-center sm:justify-start gap-3">
        ...
        <table className="w-full border-collapse min-w-[800px]">
          <thead>
            <tr className="bg-gray-50/50">
              <th className="text-left py-3 sm:py-4 px-4 sm:px-8 text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] border-b border-gray-100">Date</th>
              <th className="text-left py-3 sm:py-4 px-4 sm:px-8 text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] border-b border-gray-100">Description</th>
              <th className="text-right py-3 sm:py-4 px-4 sm:px-8 text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] border-b border-gray-100">Debit (IN)</th>
              <th className="text-right py-3 sm:py-4 px-4 sm:px-8 text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] border-b border-gray-100">Credit (OUT)</th>
              <th className="text-right py-3 sm:py-4 px-4 sm:px-8 text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] border-b border-gray-100 text-primary">Balance</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-gray-50">
            {data.map((entry, idx) => (
              <tr key={idx} className="hover:bg-gray-50/50 transition-colors group">
                <td className="py-3 sm:py-4 px-4 sm:px-8 whitespace-nowrap">
                ...
                <td className="py-3 sm:py-4 px-4 sm:px-8 text-right bg-primary/0 group-hover:bg-primary/5 transition-colors">
