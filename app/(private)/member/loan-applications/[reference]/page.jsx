        ...
        return (
          <>
            <Button
              ...
              onClick={() =>
                router.push(`/loan-applications/${reference}/edit`)
              }
            >
            ...
            <Button
              ...
              className="w-full justify-start"
              onClick={() =>
                router.push(`/loan-applications/${reference}/guarantors`)
              }
            >
        ...
        <CardContent>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-sm">
            ...
            <div>
              ...
              <p className="font-bold">{loan.projection?.term_months} months</p>
            </div>
            <div>
